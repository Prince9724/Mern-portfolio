...
const projects = [
  {
    ...
    shortDescription: 'A comprehensive Core Banking System built using the MERN stack with role-based authentication.',
    ...
    githubUrl: 'https://github.com/Prince9724/core-banking-system',
    liveUrl: '#',
    category: 'Full Stack',
    featured: true,
    status: 'published',
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/Prince9724/restaurant-pos',
    liveUrl: '#',
    category: 'Frontend',
    featured: true,
    status: 'published',
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/Prince9724/ecommerce-app',
    liveUrl: '#',
    category: 'Full Stack',
    featured: true,
    status: 'published',
  ...
  },
  {
    title: 'Twitter Clone',
    slug: 'twitter-clone',
    shortDescription: 'A social media application inspired by Twitter with a modern feed interface.',
    ...
    githubUrl: 'https://github.com/Prince9724/twitter-clone',
    liveUrl: '#',
    category: 'Frontend',
    featured: false,
    status: 'published',
  ...
  },
  {
    ...
    shortDescription: 'A Human Resource Management System designed to manage employees and HR operations.',
    ...
    githubUrl: 'https://github.com/Prince9724/hrms',
    liveUrl: '#',
    category: 'Full Stack',
    featured: true,
    status: 'published',
  ...
  },
  {
    ...
    shortDescription: 'A responsive weather application using external API integration.',
    ...
    githubUrl: 'https://github.com/Prince9724/weather-app',
    liveUrl: '#',
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/Prince9724/quiz-app',
    liveUrl: '#',
    category: 'Frontend',
    featured: false,
    status: 'published',
  ...
  },
  {
    ...
    shortDescription: 'A modern mobile shopping website for smartphones and mobile products.',
    ...
    githubUrl: 'https://github.com/Prince9724/cellcity',
    liveUrl: '#',
    category: 'E-Commerce',
    featured: false,
    status: 'published',
  ...
  },
  {
    title: 'ShopSphere',
    slug: 'shopsphere',
    shortDescription: 'A modern shopping platform for a clean online shopping experience.',
    ...
    githubUrl: 'https://github.com/Prince9724/shopsphere',
    liveUrl: '#',
    category: 'E-Commerce',
    featured: false,
    status: 'published',
  ...
  },
  {
    ...
    shortDescription: 'A modern fashion e-commerce platform with a premium shopping experience.',
    ...
    githubUrl: 'https://github.com/Prince9724/stylehub',
    liveUrl: '#',
    category: 'Full Stack',
    featured: true,
    status: 'published',
  ...
  },
  {
    ...
    shortDescription: 'A complete developer portfolio with a secure admin CMS for dynamic content management.',
    ...
    githubUrl: 'https://github.com/Prince9724/portfolio',
    liveUrl: '#',
    category: 'Full Stack',
    featured: true,
    status: 'published',
